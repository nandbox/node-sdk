...
module.exports = class IncomingMessage {
  ...
  toJsonObject() {
    ...
    if (this.voice) obj.voice = this.voice.toJsonObject();
    if (this.video) obj.video = this.video.toJsonObject();
    if (this.audio) obj.audio = this.audio.toJsonObject();
    if (this.sticker) obj.sticker = this.sticker.toJsonObject();
    if (this.text_file) obj.text_file = this.text_file.toJsonObject();
